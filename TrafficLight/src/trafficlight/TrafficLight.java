...
public class TrafficLight extends JFrame implements ActionListener {
    ...
    public TrafficLight(){
        ...
        JPanel lights = new JPanel( new GridLayout(3,1) );
        lights.setSize(new Dimension(800,800));
        
        //JPanel.setAlignment(Pos.CENTER);
        // adding lights to JPanel flowlayout instead of scene 
        lights.add( green );
        lights.add( yellow );
        lights.add( red );
        ...
        //color change event using repaint
        btnPane.add(btn3);
...
class TrafficSignal extends JPanel {
    ...
    public void paintComponent(Graphics g){
       g.setColor( Color.black );
        ...
        // fills the circles of the traffic light and sets size. 
        g.fillOval( border,border,2*(radius/2),2*(radius/2) );
